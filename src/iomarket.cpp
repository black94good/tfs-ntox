...
namespace IOMarket {
	...
	void checkExpiredOffers() {
		...
		g_databaseTasks.addTask(fmt::format("SELECT `id`, `amount`, `price`, `itemtype`, `player_id`, `sale` FROM `market_offers` WHERE `created` <= {:d}", lastExpireDate), processExpiredOffers, true);
